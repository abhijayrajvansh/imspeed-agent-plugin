...
digraph process {
    ...
    "Use imspeed:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent (../requesting-code-review/code-reviewer.md)" -> "Use imspeed:finishing-a-development-branch";
}
```
...
tasks, dispatch `imspeed-final-reviewer`; use
`imspeed-final-reviewer-deep` for
...
- Final whole-branch review: use imspeed:requesting-code-review's [code-reviewer.md](../requesting-code-review/code-reviewer.md)
...
[Read plan file once: docs/imspeed/plans/feature-plan.md]
...
You: "User level (~/.config/IMSpeed/hooks/)"
...
- **imspeed:using-git-worktrees** - Ensures isolated workspace (creates one or verifies existing)
- **imspeed:writing-plans** - Creates the plan this skill executes
- **imspeed:requesting-code-review** - Code review template for the final whole-branch review
- **imspeed:finishing-a-development-branch** - Complete development after all tasks

**Subagents should use:**
- **imspeed:test-driven-development** - Subagents follow TDD for each task

**Alternative workflow:**
- **imspeed:executing-plans** - Use for parallel session instead of same-session execution
